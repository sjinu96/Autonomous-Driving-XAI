...
main_av2 : Robust를 psi 느리게 증가하게끔 pos를 1->0.2, psi 220->30.
...
ROBUST_ADAPT_PSI_0 = 30 # 0604변경
ROBUST_ADAPT_PSI = 0.02
ROBUST_ADAPT_EPS_POS = 0.2 # 0604 변경2
ROBUST_ADAPT_EPS_NEG = 0.01

# Offset as [mean, std] of data input.
MODEL_INPUT_OFFSET = [[0.3006, 0.2956, 0.2926], [0.2196, 0.2133, 0.2098]]
...
root='../BDD100K_MOT2020_image/bdd100k/images/track/train_av' # 0604
...
def _model_save(path, m, training_options): # 0604 
